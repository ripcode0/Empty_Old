...
{
public:
	static GLenum GetVertextFormat(VertexFormat format);
...
{
public:
	static DXGI_FORMAT	GetVertexFormat(VertexFormat format, uint formatSize);
	static D3D_PRIMITIVE_TOPOLOGY	GetTopology(Topology topology);
	static DXGI_FORMAT GetFormat(Format format);
};
